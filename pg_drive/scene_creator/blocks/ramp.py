...
from pg_drive.scene_creator.basic_utils import check_lane_on_road, ExtendStraightLane, CreateRoadFrom, Decoration, \
...
class OutRampOnStraight(Ramp):
    ...
    def _try_plug_into_previous_block(self) -> bool:
        ...
        dec_lane = ExtendStraightLane(
            self.positive_basic_lane, dec_lane_len + self.lane_width, [LineType.STRIPED, LineType.SIDE]
        )
