...
class Terrain(Element):
    ...
    def __init__(self):
        ...
        if self.render:
            ...
            self.terrain_normal = self.loader.loadTexture(VisLoader.file_path(VisLoader.path, "textures","grass2","normal.jpg"))
            self.terrain_texture = self.loader.loadTexture(VisLoader.file_path(VisLoader.path, "textures","grass2","color.jpg"))
