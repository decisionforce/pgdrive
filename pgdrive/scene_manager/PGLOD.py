...
class PGLOD:
    ...
    @classmethod
    def cull_distant_blocks(cls, blocks: list, poses: List[tuple], max_distance=None):
    ...
    @classmethod
    def cull_distant_traffic_vehicles(cls, vehicles: list, poses: List[tuple], max_distance=None):
        cls._cull_elements(
            vehicles, poses, cls.LOD_VEHICLE_VIS_DIST, max_distance or cls.LOD_VEHICLE_PHYSICS_DIST
        )

    @classmethod
    def cull_distant_objects(cls, objects: list, poses: List[tuple], max_distance=None):
        cls._cull_elements(
            objects, poses,cls.LOD_OBJECT_VIS_DIST, max_distance or cls.LOD_OBJECT_PHYSICS_DIST
        )
