...
class OutFork(Fork):
    ...
    def _try_plug_into_previous_block(self) -> bool:
        ...
        no_cross = (not check_lane_on_road(self._global_network, dec_side_right_lane, 0.95, ignore_intersection_checking=ignore_intersection_checking)) and no_cross
        ...
        self.block_network.add_lane(bend_1_road.start_node, bend_1_road.end_node, bend_1)
        self.block_network.add_lane(connect_road.start_node, connect_road.end_node, connect_part)
        no_cross = (not check_lane_on_road(self._global_network, bend_1, 0.95,ignore_intersection_checking=ignore_intersection_checking)) and no_cross
        no_cross = (not check_lane_on_road(self._global_network, connect_part, 0.95,ignore_intersection_checking=ignore_intersection_checking)) and no_cross
        ...
        no_cross = (not check_lane_on_road(self._global_network, bend_2, 0.95,ignore_intersection_checking=ignore_intersection_checking)) and no_cross
        no_cross = (not check_lane_on_road(self._global_network, straight_part, 0.95,ignore_intersection_checking=ignore_intersection_checking)) and no_cross
