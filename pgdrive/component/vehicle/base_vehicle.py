...
class BaseVehicle(BaseObject):
    ...
    def destroy(self):
        ...
        # FIXME I am working on this to make the creation/destroy process more pyhonic
        self.chassis_np.removeNode()
        self.chassis_np = None
        if self.chassis_beneath_np.node() in self.dynamic_nodes:
            self.dynamic_nodes.remove(self.chassis_beneath_np.node())
        self.chassis_beneath_np.removeNode()
        self.chassis_beneath_np = None
