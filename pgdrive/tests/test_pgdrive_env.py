...
blackbox_test_configs = dict(
    ...
    no_lidar0=dict(target_vehicles_config={DEFAULT_AGENT:dict(lidar=dict(num_lasers=0, distance=0, num_others=0))}),
    no_lidar1=dict(target_vehicles_config={DEFAULT_AGENT:dict(lidar=dict(num_lasers=0, distance=10, num_others=0))}),
    no_lidar2=dict(target_vehicles_config={DEFAULT_AGENT:dict(lidar=dict(num_lasers=10, distance=0, num_others=0))}),
    no_lidar3=dict(target_vehicles_config={DEFAULT_AGENT:dict(lidar=dict(num_lasers=0, distance=0, num_others=10))}),
    no_lidar4=dict(target_vehicles_config={DEFAULT_AGENT:dict(lidar=dict(num_lasers=10, distance=10, num_others=0))}),
    no_lidar5=dict(target_vehicles_config={DEFAULT_AGENT:dict(lidar=dict(num_lasers=10, distance=0, num_others=10))}),
    no_lidar6=dict(target_vehicles_config={DEFAULT_AGENT:dict(lidar=dict(num_lasers=0, distance=10, num_others=10))}),
    no_lidar7=dict(target_vehicles_config={DEFAULT_AGENT:dict(lidar=dict(num_lasers=10, distance=10, num_others=10))}),
)
