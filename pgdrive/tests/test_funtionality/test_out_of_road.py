    ...
    for steering in [-0.01, 0.01]:
        for distance in [10, 50, 100]:
            env = PGDriveEnvV2(dict(
                map="SSSSSSSSSSS", vehicle_config=dict(side_detector=dict(num_lasers=120, distance=distance)),
            ...
            try:
                ...
                for _ in range(100000000):
                    ...
                    if d:
                        ...
                        print("Side detector minimal distance: {}, Current distance: {}, steering: {}".format(
