var title_corpus = [
    ['PGDrive: An Open-ended Driving Simulator <br>with Infinite Scenes', 'PG驾驶：一个拥有无限场景的开放驾驶平台'],
    ['Overview', '总览'],
    ['Results', '结果'],
]
var author_corpus = [
...
var text_corpus = [
    ...
    PGDrive!', '为了更好地评估和改善基于强化学习的自动驾驶系统的范化性能， 我们提出了一个开放、极易配置的模拟器：PG开车！PG开车可以通过过程生成生成无限多的地图\
    ，从而造福面向学习系统范化性能的研究。欢迎访问 <a href="https://github.com/decisionforce/pgdrive">github.com/decisionforce/pgdrive</a> 来亲身感受！'],
    ['We generate maps with these elementary road blocks:', '我们用了以下基础路块来生成地图：'],
    ['Here are various generated maps:', '以下是生成的地图'],
    ['Agents trained with more maps show better test performance, showing that PGDrive endows agent with generality:', '在训练中见识过更多地图的智能体展现出了更优越的测试性能。这无疑说明了我们的PG开车赋予了智能体更强大的泛化能力！'],
